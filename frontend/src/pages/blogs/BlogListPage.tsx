...
export default function BlogListPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      {/* Hero */}
      <div className="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-2xl p-8 mb-8 text-white">
        <div className="flex items-center gap-3 mb-2">
          <span className="material-symbols-outlined text-3xl">article</span>
          <h1 className="text-2xl md:text-3xl font-extrabold">Blog</h1>
        </div>
        <p className="text-white/80 text-sm md:text-base max-w-2xl">
          Wissensbeitraege, Tutorials und Erfahrungsberichte rund um die Pfadfinderarbeit.
          Von Methodik ueber Recht bis hin zu praktischen Tipps.
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {data.items.map((blog) => (
                <ContentCard
                  ...
                  typeIcon="article"
                  typeBadgeColor="text-indigo-600"
