...
- [x] 11.1 Update `openspec/specs/meal-item-splits/spec.md` to `## REMOVED Requirements`
- [x] 11.2 Update `openspec/specs/recipe-exchanges/spec.md` with `## MODIFIED Requirements` for delete-protection
- [x] 11.3 Update `openspec/specs/recipe-optional-items/spec.md` with `## MODIFIED Requirements` for delete-protection
