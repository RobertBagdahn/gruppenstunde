...
DEPRECATED: Aliases are now generated by `enrich_seeds` and stored directly
in the `supply_ingredientalias.json` fixture file. This command is no longer
needed after running `enrich_seeds`.
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        warnings.warn(
            "seed_plural_aliases is deprecated. Aliases are now generated by "
            "`enrich_seeds` and stored in the fixture data. "
