...
from content.services.embedding_service import build_ingredient_embedding_text, create_embedding
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--num-ingredients", type=int, default=100, help="Number of ingredients to test (default: 100)"
        )
    ...
    def reduce_with_svd(self, vectors, target_dim):
        ...
        U, S, _Vt = np.linalg.svd(vectors, full_matrices=False)
    ...
    def handle(self, *args, **options):
        ...
        results = {"baseline_dim": 3072, "num_ingredients": len(ingredients), "methods": {}}
