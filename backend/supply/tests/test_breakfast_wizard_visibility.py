...
class TestBreakfastWizardVisibility(TestCase):
    ...
    def setUpTestData(cls):
        ...
        GroupMembership.objects.create(user=cls.user_woelflinge, group=cls.group_woelflinge)
        ...
        GroupMembership.objects.create(user=cls.user_jungpfadfinder, group=cls.group_jungpfadfinder)
...
class TestRecipeVisibility(TestCase):
    ...
    def setUpTestData(cls):
        ...
        GroupMembership.objects.create(user=cls.user1, group=cls.group1)
