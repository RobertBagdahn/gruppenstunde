...
Migrated from idea/services/norm_person.py to supply/services/.
"""
...
def calculate_tdee(bmr: float, pal: float) -> float:
    """Calculate Total Daily Energy Expenditure. TDEE = BMR * PAL."""
    return bmr * pal
...
def _get_norm_tdee() -> float:
    """Get the TDEE for the reference norm person."""
