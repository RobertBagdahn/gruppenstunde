...
class TestNutritionContributions:
    def _make_recipe_with_items(self):
        ...
        nudeln = make_ingredient(
            name="Nudeln",
            energy_kj=1500.0, protein_g=12.0, fat_g=2.0, fat_sat_g=0.5,
        ...
        tomaten = make_ingredient(
            name="Tomatensoße",
            energy_kj=200.0, protein_g=1.5, fat_g=0.5, fat_sat_g=0.1,
        ...
        kaese = make_ingredient(
            name="Käse",
            energy_kj=1600.0, protein_g=25.0, fat_g=30.0, fat_sat_g=18.0,
    ...
    def test_sugar_free_items_have_zero_sugar_contribution(self):
        ...
        ing = make_ingredient(
            name="Wasser",
            energy_kj=0.0, protein_g=0.0, fat_g=0.0, fat_sat_g=0.0,
