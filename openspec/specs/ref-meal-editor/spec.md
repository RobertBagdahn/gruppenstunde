# ref-meal-editor Specification

## Purpose

This specification defines the RefMeal editor feature for composing reference meals from recipes, with permission-restricted editing.
## Requirements
