...
- **WHEN** der Client `POST /api/supply/breakfast-days/` mit `{ name: "Tag 4" }` aufruft
...
- **THEN** sieht er eine Sektion "Frühstückstage" mit Pills für alle verfügbaren Frühstückstage
