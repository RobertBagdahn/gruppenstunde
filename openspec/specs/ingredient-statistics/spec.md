# ingredient-statistics Specification

## Purpose
Defines interactive ingredient statistics with 20 curated tabs across leaderboards, distributions, correlations, tag lists, scores, and outlier detection. Statistics are publicly accessible, mobile-optimized, and powered by dedicated API endpoints responding in under 200ms.
