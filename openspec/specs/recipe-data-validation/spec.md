# recipe-data-validation Specification

## Purpose
Specifies the management command and validation rules to identify and fix unrealistic ingredient quantities in recipe data, supporting data integrity on both local and production databases.
