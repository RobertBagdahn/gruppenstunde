# portion-picker Specification

## Purpose
Custom portion dropdown with grouped sections (ingredient portions, standard measures, gram entry) for recipe ingredient editing, including backend-authoritative piece-count semantics.
