# ingredient-replacement Specification

## Purpose

Direct replacement of one recipe ingredient (RecipeItem) with a selected portion of another ingredient while preserving item context and technical quantity.
