# ai-log-viewer Specification

## Purpose
Admin-Monitoring der KI-Interaktionen: paginierter, filterbarer Log-Viewer, Detail-Endpoint mit Prompt/Antwort, Pro-User-Kostenaggregation und erweiterte Stats mit Kosten-, Modell- und Embedding-Metriken.
