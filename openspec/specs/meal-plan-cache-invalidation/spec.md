# Spec: Meal Plan Cache Invalidation

Synchronisierte TanStack-Query-Invalidierung für alle Reiter des Essensplaners nach beliebigen Mutationen.

## Purpose
Stellt sicher, dass nach Änderungen an Mahlzeiten, Tagen, Zuweisungen oder Plan-Einstellungen alle abhängigen Reiter (Einkaufsliste, Nährwerte, Kosten, Prüfungen/Vorschläge, Kochplan) synchron aktualisiert werden.
