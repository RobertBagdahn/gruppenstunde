...
The system SHALL keep `Stück` as a named portion concept backed by `Portion.weight_g`; it SHALL NOT require or create a dedicated `MeasuringUnit` record for `Stück`.
