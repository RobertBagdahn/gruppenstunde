...
- **THEN** MÜSSEN 14 Topping-Zutaten mit Tag `breakfast-topping` existieren
- **THEN** MÜSSEN 8 Drink-Rezepte mit Tag `breakfast-drink` existieren
- **THEN** MÜSSEN 2 warme Frühstücksrezepte (Rührei, Pfannkuchen) mit Tag `breakfast-warm-meal` existieren
